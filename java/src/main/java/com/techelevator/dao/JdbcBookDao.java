...
public class JdbcBookDao implements BookDao{
    ...
    public Book getBookByID(int id)
    {
        ...
        SqlRowSet rowset = jdbcTemplate.queryForRowSet(BeeHiveSql.GET_BOOK_BY_ID.getSqlString(),id);
    ...
    public List<Book> getAllBooksByUserId(int memberId)
    {
        ...
        SqlRowSet rowSet = jdbcTemplate.queryForRowSet(BeeHiveSql.GET_BOOK_BY_USER_ID.getSqlString(),memberId);
        while(rowSet.next())
        {
    ...
    //TODO this doesnt exist, add functionality
    @Override
    public boolean deleteBook(int id)
    {
        BeeHiveSql.DELETE_BOOK.getSqlString();
        return true;
    }
    ...
    public Integer addBook(Book book)
    {
        ...
        Integer newBookId = jdbcTemplate.queryForObject(BeeHiveSql.ADD_BOOK.getSqlString(), Integer.class,book.getISBN(),book.getCoverUrl(),
    ...
    public List<Integer> getRecentBooks(int memberId)
    {
        ...
        SqlRowSet rowSet = jdbcTemplate.queryForRowSet(BeeHiveSql.GET_RECENT_BOOKS.getSqlString(), memberId);
    ...
    public List<Book> userBookList (int memberId)
    {
     ...
     /*   String sql = "SELECT b.id, b.isbn, b.cover_url,  b.title, b.author, mb.is_completed\n" +
                ...
                "\tON b.id=mb.book_id\n" +
                "WHERE mb.member_id = ?";*/
        SqlRowSet rowSet =  jdbcTemplate.queryForRowSet(BeeHiveSql.USER_BOOKS.getSqlString(), memberId);
    ...
    public boolean addMemberBookTable(MemberBookDto memberBook)
    {
     ...
     /*   String sql = "INSERT INTO member_book(\n" +
       ...
       return jdbcTemplate.update(BeeHiveSql.ADD_MEMBER_BOOK_TABLE.getSqlString(),memberBook.getMemberId(),
               memberBook.getBookId(), memberBook.isCompleted()) == 1;
    ...
    public boolean checkForRowExists(MemberBookDto memberBookDto)
    {
     ...
     /*   String sql = "SELECT member_id\n" +
        ...
        SqlRowSet rowSet = jdbcTemplate.queryForRowSet(BeeHiveSql.CHECK_FOR_ROW_EXISTS.getSqlString(),
                memberBookDto.getMemberId(), memberBookDto.getBookId());
    ...
    public boolean editMemberBookCompleted(MemberBookDto memberBook)
    {
       /* String sql = "UPDATE member_book\n" +
                ...
                "\tWHERE member_id =? AND book_id = ? ;";*/
        return jdbcTemplate.update(BeeHiveSql.EDIT_MEMBER_BOOK_COMPLETED.getSqlString(), memberBook.getMemberId(),
                memberBook.getBookId(), memberBook.isCompleted(), memberBook.getMemberId(),memberBook.getBookId()) == 1;
    }
